...
public:
  virtual void handleSetJSResponder(jsi::Runtime &rt, int tag, bool blockNativeResponder) = 0;
  virtual void handleClearJSResponder(jsi::Runtime &rt) = 0;
  virtual void createGestureHandler(jsi::Runtime &rt, jsi::String handlerName, int handlerTag, jsi::Object config) = 0;
  virtual void attachGestureHandler(jsi::Runtime &rt, int handlerTag, int newView, int actionType) = 0;
  virtual void updateGestureHandler(jsi::Runtime &rt, int handlerTag, jsi::Object newConfig) = 0;
  virtual void dropGestureHandler(jsi::Runtime &rt, int handlerTag) = 0;
...
private:
  ...
  public:
    ...
    void handleSetJSResponder(jsi::Runtime &rt, int tag, bool blockNativeResponder) override {
      static_assert(
    ...
    void createGestureHandler(jsi::Runtime &rt, jsi::String handlerName, int handlerTag, jsi::Object config) override {
      static_assert(
    ...
    void attachGestureHandler(jsi::Runtime &rt, int handlerTag, int newView, int actionType) override {
      static_assert(
    ...
    void updateGestureHandler(jsi::Runtime &rt, int handlerTag, jsi::Object newConfig) override {
      static_assert(
    ...
    void dropGestureHandler(jsi::Runtime &rt, int handlerTag) override {
      static_assert(
