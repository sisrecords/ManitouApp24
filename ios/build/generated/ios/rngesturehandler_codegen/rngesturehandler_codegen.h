...
- (void)handleSetJSResponder:(NSInteger)tag
        blockNativeResponder:(BOOL)blockNativeResponder;
- (void)handleClearJSResponder;
- (void)createGestureHandler:(NSString *)handlerName
                  handlerTag:(NSInteger)handlerTag
                      config:(NSDictionary *)config;
- (void)attachGestureHandler:(NSInteger)handlerTag
                     newView:(NSInteger)newView
                  actionType:(NSInteger)actionType;
- (void)updateGestureHandler:(NSInteger)handlerTag
                   newConfig:(NSDictionary *)newConfig;
- (void)dropGestureHandler:(NSInteger)handlerTag;
- (NSNumber *)install;
